...
export default function ContactPage() {
      ...
      <main className={styles.mainContent}>
        ...
        >
          <motion.div className={styles.infoCard} variants={itemVariants}>
            ...
            <h3>Visit Us</h3>
            <p>5/2 AZAD NAGAR TOWN ARIYA JHUNSI </p>
            <p>ALLAHABAD , UP ,PIN-211019</p>
          </motion.div>
  ...
  <div className={styles.mapWrapper}>
    <iframe
      src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d7206.2905266108055!2d81.901659!3d25.4334066!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1759734462442!5m2!1sen!2sin"
      width="100%"
      height="450"
      style={{ border: 0 }}
      allowFullScreen
